  ...
  return (
    <header className="fixed top-[20px] right-0 left-0 px-[16px] z-[10000]">
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg:white dark:bg-background px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
